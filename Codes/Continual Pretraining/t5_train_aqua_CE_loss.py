...
if __name__ == '__main__':
    ...
    log_dir = os.path.join('logs', 'T5_loss_update_large_mask_50_1')
    if not os.path.exists(log_dir):
        os.makedirs(log_dir)
    
    # create a logger instance
    logger = TensorBoardLogger(save_dir='logs/', name='T5_loss_update_large_mask_50_1')
       
    # Save the model and configuration
    checkpoint_dir = 'checkpoints/T5_loss_update_large_mask_50_1/'
